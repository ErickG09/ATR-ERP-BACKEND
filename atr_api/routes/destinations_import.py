...
from atr_api.services.destinations_excel_import_service import import_destinations_from_excel


bp = Blueprint("destinations_import", __name__)


@bp.post("/clients/<int:client_id>/destinations/import-excel")
def import_destinations_excel(client_id: int):
    """
    Importa destinatarios (destinations) desde un Excel.
    ...
    result = import_destinations_from_excel(
        client_id=client_id,
        file_storage=f,
        dry_run=dry_run,
