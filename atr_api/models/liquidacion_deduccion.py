...
class LiquidacionDeduccion(db.Model):
    ...
    # "key" es opcional: útil para conceptos predefinidos (infonavit, fonacot, etc.)
    # para los dinámicos puedes dejarlo null.
    key = db.Column(db.String(64), nullable=True)

    # lo que se mostrará siempre en auditoría ("FONACOT", "Pensión alimenticia", "Caseta extra", etc.)
